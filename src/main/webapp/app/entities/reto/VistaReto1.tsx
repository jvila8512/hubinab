...
const VistaReto1 = (
  ...
  const atras = () => {
    props.history.push(`/entidad/reto/retogrid/${props.match.params.idecosistema}/${props.match.params.index}`);
  };

  useEffect(() => {
    if (actualizarVistossoloUnavez === 0) dispatch(updateEntitysinRespuesta(props.match.params.idreto));
    else dispatch(getEntity(props.match.params.idreto));

    dispatch(getTipoIdeas({}));
    dispatch(getEntidades({}));
    setVistos(parseInt(localStorage.getItem('vistos1'), 10));
    return () => {
      localStorage.setItem('vistos1', '0');
    };
  }, []);
            ...
            <div className="grid  grid-nogutter surface-0 text-800">
              <div className="col-12 lg:col-6">
                ...
                <div className="flex align-items-center gap-3 mt-6">
                  <span className="flex align-items-center gap-2">
                    {retoEntity.motivacion && <div className="text-1xl  text-600 ">Motivación: {retoEntity.motivacion}</div>}
                  </span>
                </div>
              </div>
                ...
                <div className="flex align-items-center justify-content-center grid">
                  {retoEntity && (
                    <VistaIdeasReto1
                      ...
                      reto={retoEntity}
                      usuario={account}
                      retoid={props.match.params.idreto}
                      idecosistema={props.match.params.idecosistema}
