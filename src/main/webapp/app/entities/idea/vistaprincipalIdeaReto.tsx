...
const VistaprincipalIdeaReto = (
  ...
  const atras = () => {
    props.history.push('/entidad/reto/reto_idea/' + props.match.params.idreto);
  };
      ...
      <div className="grid grid-nogutter surface-0 text-800">
        ...
        <div className="col-12 md:col-6 p-6 text-center md:text-left flex align-items-center ">
          <section className="flex flex-column">
            ...
            <p className="font-normal text-2xl line-height-3 md:mt-3 text-gray-700">Autor1: {ideaEntity.autor}</p>
            ...
            <Button
              ...
              className={ideaEntity.aceptada ? 'p-button-danger mr-2' : 'p-button-success mr-2'}
              onClick={saveEntity}
              disabled={updating}
            />
          </section>
          <div className="col-12 md:col-6 overflow-hidden">
            {loading ? (
              <div className="flex">
                <Skeleton width="40rem" height="40rem"></Skeleton>
              </div>
            ) : (
              <img
...
export default VistaprincipalIdeaReto;
