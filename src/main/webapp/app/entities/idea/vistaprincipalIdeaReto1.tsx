...
const VistaprincipalIdeaReto1 = (
  ...
  const atras = () => {
    props.history.push('/entidad/reto/reto_idea/' + props.match.params.idreto + '/' + props.match.params.index);
  };
...
export default VistaprincipalIdeaReto1;
