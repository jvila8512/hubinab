        ...
        <div className="surface-section px-1 py-4 md:px-6 lg:px-8 text-center">
          ...
          <div className="flex align-items-center justify-content-center grid ">
            {noticiasList.map((noticia, i) => (
              <div key={noticia.id} className="w-30rem h-30rem sm:w-24rem  col-12  sm:col-6 lg:col-6 xl:col-4 p-2 relative shadow-2 m-2">
                <div className="p-4">
                  ...
                  <div className="text-1xl font-bold  h-3rem text-600 text-blue-600 overflow-hidden text-overflow-ellipsis">
                    {noticia.titulo}
                  </div>

                  <div className=" mt-4 surface-overlay w-full h-3rem   overflow-hidden text-overflow-ellipsis">{noticia.descripcion}</div>

                  <div className="flex flex-column sm:flex-row justify-content-between align-items-center gap-3 mb-2  absolute bottom-0 left-0 mb-1 ml-5">
                    <span className="flex align-items-center gap-2">
                      <i className="pi pi-calendar"></i>
                      {noticia.fechaCreada ? <TextFormat type="date" value={noticia.fechaCreada} format={APP_LOCAL_DATE_FORMAT} /> : null}
                    </span>
                  </div>
                  <div className="flex absolute  bottom-0 right-0 mb-1 mr-4">
                    <Link
